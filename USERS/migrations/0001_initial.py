    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_stdout', models.TextField(default='', max_length=1000000)),
                ('user_stderr', models.TextField(default='', max_length=1000000)),
                ('submission_time', models.DateTimeField(auto_now_add=True, null=True)),
                ('run_time', models.FloatField(default=0, null=True)),
                ('language', models.CharField(choices=[('C++', 'C++'), ('C', 's')], default='C++', max_length=10)),
